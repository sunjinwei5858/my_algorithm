...
/**
 * bst的前序结果还原bst 【力扣1008】
 * <p>
 * 思路：
 * 1。从二叉搜索树的特点出发：左子树小于根节点 右子树大于根节点
 * 2。二叉树前序遍历的特点：根节点 左子树 右子树，根节点位于数组的第一个元素
 */
public class _08_b_rebuild_bst_I {
    ...
    public static void main(String[] args) {
        _08_b_rebuild_bst_I rebuild_tree_iiii = new _08_b_rebuild_bst_I();
        // 前序遍历数组
